...
import com.ess.tudarmstadt.de.mwidgetexample.JSON.BarcodeItem;
import com.ess.tudarmstadt.de.mwidgetexample.JSON.BarcodeItemToJSON;
        ...
        onSave.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (TextUtils.isEmpty(amount)) {
                    editTextAmount.setError(getResources().getString(R.string.forgotAmount));
                    return;
                }
                String title = editText.getText().toString();
                if (TextUtils.isEmpty(title)) {
                    editText.setError(getResources().getString(R.string.forgotName));
                    return;
                }
                try {
