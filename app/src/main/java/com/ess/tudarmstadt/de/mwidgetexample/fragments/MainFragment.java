...
public class MainFragment extends Fragment {
	...
	public View onCreateView(LayoutInflater inflater, ViewGroup container,
		...
		Button test = (Button) rootView.findViewById(R.id.btn_test);
		Button start = (Button) rootView.findViewById(R.id.btn_start);

		if (MainActivity.prefs.contains("ID") && MainActivity.prefs.contains("RUNTIME")) {
			start.setVisibility(View.INVISIBLE);
		}
		if ((MainActivity.prefs.getLong("STARTTIME",0) + 40000000) < System.currentTimeMillis()) {
